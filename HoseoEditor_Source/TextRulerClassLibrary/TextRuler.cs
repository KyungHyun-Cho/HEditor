...
{//internal
    public partial class TextRuler : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new System.EventHandler(this.TextRuler_Load);
        ...
        {            
            ...
            p.Color = Color.DarkGray;//SystemColors.ActiveCaption;/
        ...
        private void DrawIndents(Graphics g)
        {
            ...
            //g.DrawImage(l_indet_pos_upper.Image, items[2]);
            //g.DrawImage(l_indent_pos_lower.Image, items[3]);
            //g.DrawImage(r_indent_pos.Image, items[4]);

            g.DrawImage(global::TextRulerClassLibrary.Properties.Resources.l_indet_pos_upper, items[2]);
            g.DrawImage(global::TextRulerClassLibrary.Properties.Resources.l_indent_pos_lower, items[3]);
            g.DrawImage(global::TextRulerClassLibrary.Properties.Resources.r_indent_pos, items[4]);
        ...
        private void DrawTabs(Graphics g)
        {
            ...
            {
                g.DrawImage(global::TextRulerClassLibrary.Properties.Resources.tab_pos, tabs[i]);
            }            
        }
        #endregion
        ...
        private void TextRuler_Load(object sender, EventArgs e)
        {
